	    ...
	    var option=$('input:radio[name=searchradio]:checked').val();
      	  if(option=="wiki"){ 
      	    ...
      	    $("#searchterm").keyup(function(e){ 
 	          ...
 	          $("#results").append("<div class='col-md-12' style='font-family:'Times New Roman'><font size='3'><a href='http://en.wikipedia.org/wiki/" + encodeURIComponent(item.title) + "'>" + item.title + "</a></font>" +"<br/>"+ item.snippet + "</div><br/><br/>");
 	          });
 	        }); 	
      	 });
      	 }
