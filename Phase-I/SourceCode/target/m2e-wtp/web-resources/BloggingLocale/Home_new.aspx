<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home_new.aspx.cs" Inherits="Home_new" %>
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <td class="style8">
         ...
         <asp:GridView ID="GridView2" AllowPaging="true" PageSize="10" runat="server"    
                Width="100%" CellPadding="3" OnRowCommand="gv_RowCommand2" 
          ...
          <asp:TemplateField Visible="false" HeaderText="Post">
                 <ItemTemplate>
                <asp:Label ID="ID22" Visible="false" runat="server" Text='<%#Eval("post")%>'></asp:Label>
               </ItemTemplate>             
         </asp:TemplateField>
     ...
     <ItemTemplate> 
      <asp:Button ID="Button1"  runat="server" Text="View" CommandName="view" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>'/>
            ...
            <asp:GridView ID="GridView1" Visible="false" runat="server"  
                Width="100%" CellPadding="3" OnRowCommand="gv_RowCommand" 
                BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" 
                BorderWidth="1px" CellSpacing="2" HorizontalAlign="Center" 
                AutoGenerateColumns="False" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true" PageSize="10">
            <Columns>
              <asp:TemplateField Visible="false" HeaderText="Post ID">
                 <ItemTemplate>
                <asp:Label ID="ID2" Visible="false" runat="server" Text='<%#Eval("postid")%>'></asp:Label>
